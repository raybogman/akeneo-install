...
php-xsl php-intl php-soap php-mbstring php-zip php-bz2 php-redis php-tidy php-apcu || exit 1
...
# Install mysql
apt-get install mysql-server || exit 1

# Install let's Encrypt
apt-get install letsencrypt || exit 1
